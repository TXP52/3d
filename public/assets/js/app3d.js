...
window.App3D = (function () {
  ...
  var NAV = [
    ...
    {
      label: 'Phân tích',
      items: [{ key: 'bao-cao', text: 'Báo cáo doanh thu', href: 'bao-cao.html', icon: 'fas fa-chart-line' }]
    },
    {
      label: 'Hệ thống',
      items: [
  ...
  var sidebar = function (active) {
    var html =
      ...
      '<span class="app3d-logo me-2"><span class="fas fa-cube"></span></span>' +
    ...
    html +=
      ...
      '<div class="btn-close-falcon-container"><div class="btn-close-falcon" data-bs-dismiss="alert" aria-label="Close"></div></div>' +
      '<div class="card-body text-center"><span class="fas fa-headset fs-3 text-primary"></span>' +
      '<p class="fs--2 mt-2">Cần hỗ trợ kỹ thuật máy in?<br />Gọi <strong>1900 6868</strong> (8h - 21h)</p>' +
      '<a class="btn btn-sm btn-primary" href="cai-dat.html">Trung tâm hỗ trợ</a></div>' +
      '</div></div>' +
      '</div></div></nav>';
  ...
  var topbar = function (title) {
    var html =
      ...
      '</div></div></li>' +
      '<li class="nav-item dropdown">' +
      '<a class="nav-link pe-0 ps-2" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><div class="avatar avatar-xl"><div class="avatar-name rounded-circle bg-soft-primary text-primary"><span>QT</span></div></div></a>' +
      '<div class="dropdown-menu dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">' +
      '<div class="bg-white dark__bg-1000 rounded-2 py-2">' +
      '<div class="px-3 py-2"><h6 class="mb-0">Quản trị viên</h6><p class="fs--2 mb-0 text-500">admin@in3dstore.vn</p></div>' +
      ...
      '<div class="dropdown-divider"></div>' +
      '<a class="dropdown-item" href="dang-nhap.html"><span class="fas fa-sign-out-alt me-2"></span>Đăng xuất</a>' +
      '</div></div></li>' +
      '</ul></nav>';
  ...
  var footer = function () {
    ...
    write(
      ...
      '<div class="col-12 col-sm-auto text-center"><p class="mb-0 text-600">Phiên bản 1.0.0</p></div>' +
      '</div></footer>'
    );
  };
    ...
    return (list || PRODUCTS)
      .map(function (p) {
        ...
        return (
          ...
          '<div class="avatar avatar-xl me-2"><div class="avatar-name rounded-circle bg-soft-primary text-primary"><span class="fas fa-cube"></span></div></div>' +
    ...
    return (list || INVENTORY)
      .map(function (i) {
        ...
        return (
          ...
          '<td class="align-middle name"><h6 class="mb-0 fs--1">' + escapeHtml(i.name) + '</h6></td>' +
  ...
  var PALETTE = ['#2c7be5', '#00d27a', '#f5803e', '#e63757', '#27bcfd', '#748194'];
